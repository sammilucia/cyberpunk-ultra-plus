...
local options = {
	tweaks = {
		...
		},
		{
			...
			tooltip = 'Uncheck this if you use reLIGHT (CP Default: On). Makes little if any difference in PTNext mode.',
		},
	},
	ptFeatures = {
		{
			...
			tooltip = 'Blends screenspace reflections with RT or PT reflections (less physically-based) but fixes some missing reflections.',
		},
		{
			item = 'ScreenSpaceUnderwater',
			name = 'Enable Screen Space Underwater',
			category = 'Developer/FeatureToggles',
			tooltip = '',
		},
		{
			item = 'EnableGlobalLight',
			name = 'Enable Path Traced Sun*',
			category = 'Editor/RTXDI',
			tooltip = 'Replaces ?raster sun with path traced sun. *May only work with PTNext. Causes wrong shadows on V',
		},
	},
	rasterFeatures = {
		{
...
--		},
	...
	postProcessFeatures = {
		{
			...
			category = 'Developer/FeatureToggles',
			tooltip = 'Does not appear to work with DLSS. May work with FSR3 (CP Default: On)',
		},
		{
			item = 'Tonemapping',
	...
	miscFeatures = {
		{
			...
			category = 'RayTracing',
			tooltip = 'If unchecked this will show your player character in reflections, except for their head, unfortunately (CP Default: Off)',
		},
		{
			item = 'weatherFix',
			name = 'Enable Weather Stuck Fix',
			category = 'internal',
			tooltip = 'Fixes a vanilla bug where the weather gets stuck and never changes',
		},
	},
	rtxDi = {
		{
	...
	nrd = {
		{
			...
			category = 'Editor/RTXDI',
			tooltip = 'NRD denoiser modification. Should be enabled with NRD. Reduces traversal noise at the with minor loss of edge detail (use sharpening)',
		},
		{
	...
	rtOptions = {
		{
			...
			tooltip = 'Probably requires Better Eye Shadow Mask Maxiumum',
		},
		{
			item = 'EnableCustomMipBias',
			name = 'Force Mip Bias (set in Debug)',
		...
		{
			item = 'EnableAutoExposure',
			name = 'DLSS Enable Auto Exposure (CTD warning)',
			category = 'DLSS',
			tooltip = '',
		},
		{
			item = 'PTEyeSpecularModEnable',
			name = 'DLSS PT Eye Specular Modulation Enable',
			category = 'DLSS',
			tooltip = '',
		},
		{
	...
	rtInt = {
		...
		{
			item = 'ForceUpdate',
			name = 'RT Forced Update',
			category = 'RayTracing/Debug',
			tooltip = '',
		},
		{
			item = 'RenderObjectType',
			name = 'RT Render Object Type',
			category = 'RayTracing/Debug',
			tooltip = '',
		},
		{
			item = 'RenderProxyType',
			name = 'RT Remder Proxy Type',
			category = 'RayTracing/Debug',
			tooltip = '',
		},
		{
	...
	rtFloat = {
		...
		{
			item = 'PreExposure',
			name = 'DLSS Pre Exposure',
			category = 'DLSS',
			tooltip = '',
		},
		{
			item = 'ExposureScale',
			name = 'DLSS Exposure Scale',
			category = 'DLSS',
			tooltip = '',
		},
		{
			item = 'PTEyeSpecularMul',
			name = 'DLSS PT Eye Specular Multiplier',
			category = 'DLSS',
			tooltip = '',
		},
		{
		...
		{
			item = 'SkinAmbientMix_Factor',
			name = 'Skin Ambient Mix Factor',
			category = 'Editor/Characters/Skin',
			tooltip = '',
		},
		{
			item = 'SkinAmbientIntensity_Factor',
			name = 'Skin Ambient Intensity Factor',
			category = 'Editor/Characters/Skin',
			tooltip = '',
		},
		{
			item = 'SubsurfaceSpecularTintWeight',
			name = 'Skin Subsurface Specular Amount',
			category = 'Editor/Characters/Skin',
			tooltip = '',
		},
		{
			item = 'SubsurfaceSpecularTint_R',
			name = 'Skin Subsurface Specular Tint (Red)',
			category = 'Editor/Characters/Skin',
			tooltip = '',
		},
		{
			item = 'SubsurfaceSpecularTint_G',
			name = 'Skin Subsurface Specular Tint (Green)',
			category = 'Editor/Characters/Skin',
			tooltip = '',
		},
		{
			item = 'SubsurfaceSpecularTint_B',
			name = 'Skin Subsurface Specular Tint (Blue)',
			category = 'Editor/Characters/Skin',
			tooltip = '',
		},
		{
			item = 'AlbedoMultiplier',
			name = 'Hair Albedo Multiplier',
			category = 'Editor/Characters/Hair',
			tooltip = '',
		},
		{
			item = 'RoughnessFactor',
			name = 'Hair Roughness',
			category = 'Editor/Characters/Hair',
			tooltip = '',
		},
		{
			item = 'AdditionalAreaRoughness',
			name = 'Hair Additional Area Roughness',
			category = 'Editor/Characters/Hair',
			tooltip = '',
		},
		{
			item = 'SpecularRandom_Min',
			name = 'Hair Specular Random Min',
			category = 'Editor/Characters/Hair',
			tooltip = '',
		},
		{
			item = 'SpecularRandom_Max',
			name = 'Hair Specular Random Max',
			category = 'Editor/Characters/Hair',
			tooltip = '',
		},
		{
			item = 'Wrap',
			name = 'Hair Specular Wrap Intensity',
			category = 'Editor/Characters/Hair/Specular',
			tooltip = '',
		},
		{
			item = 'Mask_Intensity',
			name = 'Hair Specular Mask Intensity',
			category = 'Editor/Characters/Hair/Specular',
			tooltip = '',
		},
		{
			item = 'Wrap',
			name = 'Hair Multiscatter Wrap Intensity',
			category = 'Editor/Characters/Hair/MultiScatter',
			tooltip = '',
		},
		{
			item = 'Mask_Intensity',
			name = 'Hair Multiscatter Mask Intensity',
			category = 'Editor/Characters/Hair/MultiScatter',
			tooltip = '',
		},
		{
			item = 'ShadowFactorExp',
			name = 'Hair Multiscatter Shadow Exponent',
			category = 'Editor/Characters/Hair/MultiScatter',
			tooltip = '',
		},
		{
			item = 'DiffuseScatterFactor',
			name = 'Hair Multiscatter Diffuse Scatter',
			category = 'Editor/Characters/Hair/MultiScatter',
			tooltip = '',
		},
		{
			item = 'R',
			name = 'Hair DI (Local Light) R',
			category = 'Editor/Characters/Hair/LocalLight',
			tooltip = '',
		},
		{
			item = 'TT',
			name = 'Hair DI (Local Light) TT',
			category = 'Editor/Characters/Hair/LocalLight',
			tooltip = '',
		},
		{
			item = 'TRT',
			name = 'Hair DI (Local Light) TRT',
			category = 'Editor/Characters/Hair/LocalLight',
			tooltip = '',
		},
		{
			item = 'MultiScatter',
			name = 'Hair DI (Local Light) Multi Scatter',
			category = 'Editor/Characters/Hair/LocalLight',
			tooltip = '',
		},
		{
			item = 'ScatterDepth',
			name = 'Hair DI (Local Light) Scatter Depth',
			category = 'Editor/Characters/Hair/LocalLight',
			tooltip = '',
		},
		{
			item = 'R',
			name = 'Hair Environment Probe R',
			category = 'Editor/Characters/Hair/EnvProbe',
			tooltip = '',
		},
		{
			item = 'TT',
			name = 'Hair Environment Probe TT',
			category = 'Editor/Characters/Hair/EnvProbe',
			tooltip = '',
		},
		{
			item = 'TRT',
			name = 'Hair Environment Probe TRT',
			category = 'Editor/Characters/Hair/EnvProbe',
			tooltip = '',
		},
		{
			item = 'MultiScatter',
			name = 'Hair Environment Probe Multi Scatter',
			category = 'Editor/Characters/Hair/EnvProbe',
			tooltip = '',
		},
		{
			item = 'ScatterDepth',
			name = 'Hair Environment Probe Scatter Depth',
			category = 'Editor/Characters/Hair/EnvProbe',
			tooltip = '',
		},
		{
			item = 'R',
			name = 'Hair GI (Global Light) R',
			category = 'Editor/Characters/Hair/GlobalLight',
			tooltip = '',
		},
		{
			item = 'TT',
			name = 'Hair GI (Global Light) TT',
			category = 'Editor/Characters/Hair/GlobalLight',
			tooltip = '',
		},
		{
			item = 'TRT',
			name = 'Hair GI (Global Light) TRT',
			category = 'Editor/Characters/Hair/GlobalLight',
			tooltip = '',
		},
		{
			item = 'MultiScatter',
			name = 'Hair GI (Global Light) Multi Scatter',
			category = 'Editor/Characters/Hair/GlobalLight',
			tooltip = '',
		},
		{
			item = 'ScatterDepth',
			name = 'Hair GI (Global Light) Scatter Depth',
			category = 'Editor/Characters/Hair/GlobalLight',
			tooltip = '',
		},
		{
			item = 'R',
			name = 'Hair Alpha Shift R',
			category = 'Editor/Characters/Hair/AlphaShifts',
			tooltip = '',
		},
		{
			item = 'TT',
			name = 'Hair Alpha Shift TT',
			category = 'Editor/Characters/Hair/AlphaShifts',
			tooltip = '',
		},
		{
			item = 'TRT',
			name = 'Hair Alpha Shift TRT',
			category = 'Editor/Characters/Hair/AlphaShifts',
			tooltip = '',
		},
		{
			item = 'EXP_SCALE',
			name = 'Hair Exponent Scale',
			category = 'Editor/Characters/Hair/TRT_Params',
			tooltip = '',
		},
		{
			item = 'EXP_BIAS',
			name = 'Hair Exponent Bias',
			category = 'Editor/Characters/Hair/TRT_Params',
			tooltip = '',
		},
		{
			item = 'HACK_Factor0',
			name = 'Hair Hack Factor 0',
			category = 'Editor/Characters/Hair/HACKS',
			tooltip = '',
		},
		{
			item = 'HACK_Factor1',
			name = 'Hair Hack Factor 1',
			category = 'Editor/Characters/Hair/HACKS',
			tooltip = '',
		},
		{
			item = 'HACK_Factor2',
			name = 'Hair Hack Factor 2',
			category = 'Editor/Characters/Hair/HACKS',
			tooltip = '',
		},
		{
			item = 'HACK_Factor3',
			name = 'Hair Hack Factor 3',
			category = 'Editor/Characters/Hair/HACKS',
			tooltip = '',
		},
		{
		...
		{
			item = 'ReflectionProbeBlend_Global',
			name = 'Reflection Probe Blend Global',
			category = 'Rendering',
			tooltip = '',
		},
		{
			item = 'ReflectionProbeBlend_Local',
			name = 'Reflection Probe Blend Local',
			category = 'Rendering',
			tooltip = '',
		},
		{
			item = 'ReflectionProbeBlend_StreamIn',
			name = 'Reflection Probe Blend Stream In',
			category = 'Rendering',
			tooltip = '',
		},
		{
			item = 'ReflectionProbeBlend_FillProbeSpill',
			name = 'Reflection Probe Blend Fill Probe Spill',
			category = 'Rendering',
			tooltip = '',
		},
		{
			item = 'ReflectionProbeBlend_MovingBlendSpeed',
			name = 'Reflection Probe Blend Moving Blend Speed',
			category = 'Rendering',
			tooltip = '',
		},
		{
			item = 'ReflectionProbe_FastBlend',
			name = 'Reflection Probe Fast Blend',
			category = 'Rendering',
			tooltip = '',
		},
		{
			item = 'IsoScale',
			name = 'Camera ISO Scale',
			category = 'Editor/Camera',
			tooltip = '',
		},
		{
			item = 'DiffuseGlobalScale',
			name = 'PT Global Diffuse Intensity',
			category = 'RayTracing/Reference',
			tooltip = '',
		},
		{
			item = 'SkyRadianceScale',
			name = 'PT/RT Sun Radiance Scale',
			category = 'RayTracing',
			tooltip = 'Adjusts brightness of fake sunlight in PT or RT scenes',
		},
		{
			item = 'DiffuseSunScale',
			name = 'PT Sun Diffuse Intensity',
			category = 'RayTracing/Reference',
			tooltip = '',
		},
		{
			item = 'DiffuseSkyScale',
			name = 'PT Sky Diffuse Intensity',
			category = 'RayTracing/Reference',
			tooltip = '',
		},
		{
			item = 'DiffuseLocalLightsScale',
			name = 'PT Local Lights Diffuse Intensity',
			category = 'RayTracing/Reference',
			tooltip = '',
		},
		{
			item = 'DiffuseEmissiveScale',
			name = 'PT Emissive Diffuse Intensity',
			category = 'RayTracing/Reference',
			tooltip = '',
		},
		{
			item = 'GIOnlyLightScale',
			name = 'PT Global Illumination Brightness',
			category = 'RayTracing/Reference',
			tooltip = '',
		},
		{
			item = 'SpecularGlobalScale',
			name = 'PT Specular Global Brightness',
			category = 'RayTracing/Reference',
			tooltip = '',
		},
		{
			item = 'SpecularSunScale',
			name = 'PT Sun Specular Intensity',
			category = 'RayTracing/Reference',
			tooltip = '',
		},
		{
			item = 'SpecularSkyScale',
			name = 'PT Sky Specular Intensity',
			category = 'RayTracing/Reference',
			tooltip = '',
		},
		{
			item = 'SpecularLocalLightsScale',
			name = 'PT Local Lights Specular Intensity',
			category = 'RayTracing/Reference',
			tooltip = '',
		},
		{
			item = 'SpecularEmissiveScale',
			name = 'PT Emissive Specular Intensity',
			category = 'RayTracing/Reference',
			tooltip = '',
		},
		{
			item = 'MaxIntensity',
			name = 'PT Maximum Overall Intensity',
			category = 'RayTracing/Reference',
			tooltip = '',
		},
		{
			item = 'AlbedoModulation',
			name = 'PT Albedo Modulation',
			category = 'RayTracing/Reference',
			tooltip = '',
		},
		{
		...
		{
			item = 'EmissiveShadowRayOffset',
			name = 'Emissive Shadow Ray Offset',
			category = 'Editor/RTXDI',
			tooltip = '',
		},
		{
