...
function Config.SetMode(mode)
	...
	if mode == Var.mode.PT16 then
		...
		Cyberpunk.SetOption('Editor/Denoising/ReBLUR/Direct', 'AntiFirefly', true)		--added for 5.3.4 (moved from quality.lua)
		Cyberpunk.SetOption('Editor/Denoising/ReBLUR/Indirect', 'AntiFirefly', true)		--added for 5.3.4 (moved from quality.lua)
		Cyberpunk.SetOption('Editor/Denoising/ReBLUR/AmbientOcclusion', 'AntiFirefly', true)	--added for 5.3.4 (moved from quality.lua)
		Cyberpunk.SetOption('Rendering/VariableRateShading', 'Enable', true)
		Cyberpunk.SetOption('Rendering/VariableRateShading', 'VarianceCutoff', '0.05')
		Cyberpunk.SetOption('Rendering/VariableRateShading', 'MotionFactor', '0.7')
		Cyberpunk.SetOption('Rendering/VariableRateShading', 'ScreenEdgeFactor', '2.0')
